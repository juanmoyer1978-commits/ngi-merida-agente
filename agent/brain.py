...
def cargar_system_prompt() -> str:
    return _cargar_prompts().get("system_prompt", "Eres un asistente útil. Responde en español.")
...
def obtener_mensaje_fallback() -> str:
    return _cargar_prompts().get("fallback_message", "Disculpa, no entendí bien tu mensaje. ¿Puedes reformularlo? 😊")
